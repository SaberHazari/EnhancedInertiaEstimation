...
plt.savefig('Learning Curve - PINN - wrv.png')
plt.show()
...
plt.savefig('Prediction Results - PINN - wrv.png')
plt.show()
...
plt.grid(True, linestyle="--", alpha=0.5)
plt.savefig('Distribution of Absolute Errors - PINN - wrv.png')
plt.show()
...
plt.grid(True, linestyle="--", alpha=0.5)
plt.savefig('Absolute Error per case - PINN - wrv.png')
plt.show()
...
plt.savefig("Metrics Summary - PINN - wrv.png", bbox_inches="tight", dpi=300)
plt.show()