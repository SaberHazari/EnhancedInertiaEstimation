...
plt.yscale('log')
plt.legend()
plt.savefig('Learning Curve - TCN - wrv.png')
plt.show()
...
plt.savefig('Prediction Results - TCN - wrv.png')
plt.show()
...
plt.savefig('Distribution of Absolute Errors - TCN - wrv.png')
plt.show()
...
plt.grid(True, linestyle="--", alpha=0.6)
plt.savefig('Absolute Error per case -TCN - wrv.png')
plt.show()
...
plt.savefig("Metrics Summary - TCN - wrv.png", bbox_inches="tight", dpi=300)
plt.show()
